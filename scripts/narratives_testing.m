...
taskname                       = 'narratives';
dir_text                       = fullfile(task_dir,'stimuli','text');
dir_audio                      = fullfile(task_dir,'stimuli','audio_48');

counterbalancefile             = fullfile(task_dir,'design', 'task-narratives_counterbalance_ver-01_48k.csv');
